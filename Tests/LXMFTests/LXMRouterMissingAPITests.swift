...
final class LXMRouterMissingAPITests: XCTestCase {
  ...
  func testPrioritiseAddsHash() {
    ...
    XCTAssertTrue(
      router.isPrioritised(destinationHash: hash),
  ...
  func testIsPrioritisedDefaultsFalse() {
    let router = makeRouter()
    XCTAssertFalse(
      router.isPrioritised(destinationHash: makeHash(0xFF)),
  ...
  func testIgnoreDestinationAddsHash() {
    ...
    XCTAssertTrue(
      router.isIgnoringDestination(destinationHash: hash),
  ...
  func testIsIgnoringDestinationDefaultsFalse() {
    let router = makeRouter()
    XCTAssertFalse(
      router.isIgnoringDestination(destinationHash: makeHash(0xFE)),
