...
final class PropagationSyncTests: XCTestCase {
  ...
  func testLinkClosureBeforeEstablishmentFailsTheSync() throws {
    ...
    XCTAssertEqual(
      net.routerA.propagationTransferState, .linkEstablishing,
    ...
    XCTAssertEqual(
      net.routerA.propagationTransferState, .failed,
      """
      ...
      """)
    XCTAssertNil(
      net.routerA.outboundPropagationLink,
  ...
  func testLinkClosureMidTransferFailsTheSync() throws {
    ...
    net.routerA.requestMessagesFromPropagationNode(identity: net.identityA)
    XCTAssertEqual(
      net.routerA.propagationTransferState, .requestSent,
  ...
  func testCompletedSyncAcknowledgesToIdleWhenTheLinkCloses() throws {
    ...
    net.routerA.requestMessagesFromPropagationNode(identity: net.identityA)
    XCTAssertEqual(
      net.routerA.propagationTransferState, .done,
    ...
    XCTAssertEqual(
      net.routerA.propagationTransferState, .idle,
  ...
  func testStalledSyncTerminates() throws {
    ...
    XCTAssertEqual(net.routerA.propagationTransferState, .requestSent)
    XCTAssertEqual(
      net.routerA.outboundPropagationLink?.status, .active,
